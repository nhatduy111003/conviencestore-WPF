...
{
    public partial class ASSPRN221Context : DbContext
    {
        public ASSPRN221Context()
        {
        }

        public ASSPRN221Context(DbContextOptions<ASSPRN221Context> options)
            : base(options)
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Order>(entity =>
            {
                ...
                entity.HasOne(d => d.User)
                    ...
                    .HasConstraintName("FK__Order__user_id__4222D4EF");
            });

            modelBuilder.Entity<OrderProduct>(entity =>
            {
                entity.HasKey(e => new { e.OrderId, e.ProductId })
                    .HasName("PK__Order_Pr__022945F617BB7855");
